...
The project focuses on clinical risk prediction, explainable AI (XAI), and explanation reliability analysis using SHAP and LIME across multiple machine learning models.
...
The notebook follows an end-to-end explainable machine learning pipeline.
